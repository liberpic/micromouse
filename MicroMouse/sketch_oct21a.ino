...
int const LPWMPin=6;      
int const LIn2=4;
int const REncoderPin=2;
int const LEncoderPin=3;
...
void setup()
{
  ...
  attachInterrupt(0, Rchange, CHANGE);
  attachInterrupt(1, Lchange, CHANGE);
